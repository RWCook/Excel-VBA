...
| Display Formula Window after typing formula name.	 | Ctrl+A |
...
| Find and Replace with Replace Selected | Ctrl+h |
...
| Set diagonal and down border | Alt+d* |
